...
def metragem_limpeza():
    print('-' * 27, 'MENU 1 de 3 - Metragem da Limpeza', '-' * 26)
    ...
    while True:
        ...
        # Caso o usuario digite letras ou valores quebrados em vez de valores inteiros
            ...
            print('!' * 27, 'Valores não inteiros não são aceitos', '!' * 26)
...
def tipo_limpeza():
    print('-' * 27, 'MENU 2 de 3 - Tipo de Limpeza', '-' * 26)
...
def adicional_limpeza():
    print('-' * 27, 'MENU 3 de 3 - Adicional de Limpeza', '-' * 26)
...
borda('          Bem-vindo ao Programa de Serviços de Limpezas DANILO BERNARDI             ')
...
print(
    'Valor total ficou: R$ {:.2f} (Metragem: R$ {:.2f} + Tipo de Limpeza R$ {:.2f} + Adicional R$ {:.2f})'.format(total,
                                                                                                                  metragem,
                                                                                                                  tipo,
                                                                                                                  adicinal))
